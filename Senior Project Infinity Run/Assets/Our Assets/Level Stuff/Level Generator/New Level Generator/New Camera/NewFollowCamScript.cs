...
public class NewFollowCamScript : MonoBehaviour
{
    ...
    void AdjustCamera()
    {
        ...
        Vector3 direction = Target.GetComponent<Rigidbody2D>().velocity.normalized;
        direction.z = Boundries.z;
        Vector3 desiredPosition = new Vector3(Target.transform.position.x + direction.x * leadAmountX, Target.transform.position.y, Boundries.z);
